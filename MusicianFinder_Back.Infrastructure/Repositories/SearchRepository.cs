    ...
    public class SearchRepository : ISearchRepository
    {
            ...
            int instrumentId)
        {
            var musicians = await _dbContext.Musicians
                ...
                .Where(m => m.MM_MusicianInstruments
                    .Any(p => p.InstrumentIdFK == instrumentId))
                .ToListAsync();
            ...
            return musicians.Select(m => new MusicianSearchAppDto
            {
                ...
                LocationIds = m.MM_MusicianLocations
                    .Select(l => l.LocationIdFK).ToList(),

                ProjectTypeIds = m.MM_MusicianProjectTypes
                    .Select(pt => pt.ProjectTypeIdFK).ToList(),
